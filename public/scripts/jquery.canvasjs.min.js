...
(function () {
    ...
    function fb(h) {
        if (S.fSDec)
            h[ha("`eeDwdouMhrudods")](ha("e`u`@oh`uhnoHuds`uhnoDoe"), function () {
                S._fTWm && S._fTWm(h);
            });
    }
    function Xa(h, n, v) {
    ...
    function hb(h) {
        if (h._menuButton) h.exportEnabled ? (U(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), La(h._menuButton), (h._menuButton.title = h._cultureInfo.menuText)) : ua(h._menuButton);
        ...
        if (h.exportEnabled && h._dropdownMenu) {
            ...
            for (var v = h._dropdownMenu.childNodes, s = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], qa = 0; qa < v.length; qa++)
                U(v[qa], { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), (v[qa].innerHTML = s[qa]);
        } else
            !h._dropdownMenu &&
                h.exportEnabled &&
                w &&
    ...
    function ib(h) {
        if (!jb) {
            var n = !1,
                v = !1;
            "undefined" === typeof pa.Chart.creditHref ? ((h.creditHref = ha("iuuqr;..b`ow`rkr/bnl.")), (h.creditText = ha("B`ow`rKR/bnl"))) : ((n = h.updateOption("creditText")), (v = h.updateOption("creditHref")));
    ...
    Fa = {
        ...
        data: [{ indexLabelFontFamily: x, indexLabelFontSize: F, indexLabelFontColor: T, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
        axisX: [
            {
                titleFontFamily: x,
                titleFontSize: V,
        ...
        S._fTWm = function (h) {
            if ("undefined" === typeof S.pro.sCH && !cb)
                try {
                    ...
                    s = "cm" === S.pos[n] || "um" === S.pos[n] ? 0 : h.width - x[S.fSDec("ld`rtsdUdyu")](S.fSDec("B`ow`rKR!Ush`m")).width;
    ...
    Z.prototype.dispatchEvent = function (h, n, s) {
        if (h && this._eventListeners[h]) {
            n = n || {};
            for (var w = this._eventListeners[h], x = 0; x < w.length; x++) w[x].eventHandler.call(w[x].context, n);
        }
    ...
    za.prototype.setLayout = function () {
        if (this.text) {
            ...
            M = J.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ? ("top" === this.verticalAlign ? ((x = n.y1 + 2), (H = "top")) : "bottom" === this.verticalAlign && ((x = n.y2 - 2 - M.height), (H = "bottom")),
                ...
                : "center" === this.verticalAlign &&
                  ("left" === this.horizontalAlign
                      ? ((w = n.x1 + 2), (x = n.y2 - 2 - (this.maxWidth / 2 - M.width / 2)), (F = -90), (H = "left"), (this.width = M.height), (this.height = M.width))
                      : "right" === this.horizontalAlign
                      ? ((w = n.x2 - 2), (x = n.y1 + 2 + (this.maxWidth / 2 - M.width / 2)), (F = 90), (H = "right"), (this.width = M.height), (this.height = M.width))
    ...
    x = Pa.Chart = (function () {
        ...
        n.prototype.renderElements = function () {
            ...
            Ha &&
                ...
                setTimeout(function () {
                    ...
                    a && (Ma(a, m.width, m.height), a.getContext("2d").drawImage(m._eventManager.ghostCanvas, 0, 0));
                }, 2e3));
                    ...
                    for (q = 0; q < p.dataPoints.length; q++) {
                        ...
                        if (0 < q) {
                            ...
                            null !== e &&
                                ...
                                (a.axisY.logarithmic
                                    ? 0 < e && ((y = e / p.dataPoints[q - 1].y), 1 > y && (y = 1 / y), d.minDiff > y && 1 !== y && (d.minDiff = y))
                                    : ((y = e - p.dataPoints[q - 1].y), 0 > y && (y *= -1), d.minDiff > y && 0 !== y && (d.minDiff = y)));
                        }
                    ...
                    if (this._axes[l].dataInfo._dataRanges) {
                        ...
                        for (t = 0; t < Math.min(f.length, this._axes[l].scaleBreaks.maxNumberOfAutoBreaks); t++)
                            (b = a(f[t].start, f[t].end, this._axes[l].logarithmic ? this._axes[l].dataInfo.max / this._axes[l].dataInfo.min : this._axes[l].dataInfo.max - this._axes[l].dataInfo.min, this._axes[l].logarithmic)),
                                this._axes[l].scaleBreaks.autoBreaks.push(new V(this, "autoBreaks", b, t, ++this._eventManager.lastObjectId, this._axes[l].scaleBreaks)),
            ...
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                ...
                if (this.panEnabled || this.zoomEnabled) {
                    ...
                    l &&
                        ...
                        l && this.zoomEnabled && "none" === this._zoomButton.style.display && (La(this._zoomButton, this._resetButton), va(this, this._zoomButton, "pan"), va(this, this._resetButton, "reset")));
                }
            }
            this.isDrag = !1;
        ...
        n.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (null !== D && "" !== D) {
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== A
                            ? ((e = c.y1),
                              (f = c.y2),
                              0 < v
                                  ? ((g = m.point.y + ("horizontal" === C ? r / 2 : 0) - k - t - b), g < e && ((g = "auto" === A ? Math.max(m.point.y, e) + r / 2 + t : e + r / 2 + t), (x = g + k > m.point.y)))
                                  : ((g = m.point.y + r / 2 + t + b), g > f - k && ((g = "auto" === A ? Math.min(m.point.y, f) + r / 2 - k - t : f + r / 2 - k), (x = g < m.point.y))))
                        ...
                        0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? ((A = "auto"), (l = 4)) : 0 <= p.indexOf("stacked") ? "auto" === A && (A = "inside") : "bubble" === p && (A = "inside"),
                            ...
                            "inside" !== A
                                ? ((e = c.x1),
                                  (f = c.x2),
                                  0 > v
                                      ? ((q = m.point.x - ("horizontal" === C ? B : B - r / 2) - l - b), q < e && ((q = "auto" === A ? Math.max(m.point.x, e) + l : e + l), (x = q + B > m.point.x)))
                                      : ((q = m.point.x + ("horizontal" === C ? 0 : r / 2) + l + b),
                                        q > f - B - l - b && ((q = "auto" === A ? Math.min(m.point.x, f) - ("horizontal" === C ? B : B / 2) - l : f - B - l), (x = q < m.point.x))))
                    ...
                    y &&
                        "inside" !== A &&
                        ((0 > p.indexOf("bar") && ("error" !== p || !m.axisSwapped) && m.point.x > c.x1 && m.point.x < c.x2) || !x) &&
                        ((0 > p.indexOf("column") && ("error" !== p || m.axisSwapped) && m.point.y > c.y1 && m.point.y < c.y2) || !x) &&
                        ((d.lineWidth = y),
                                ...
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || C || n) && (c.stroke(), w && b.stroke()), (C = !0);
                                    ...
                                    n || C
                                        ? (!n && k.connectNullData
                                          ...
                                          (C = n = !1))
                                        : (c.lineTo(y, s), w && b.lineTo(y, s), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(y, s), w && (b.stroke(), b.beginPath(), b.moveTo(y, s))));
                                    l = { x: y, y: s };
                                    u < m.length - 1 &&
                                    ...
                                    if (0 < m[u].markerSize || 0 < k.markerSize) {
                                        ...
                                        f.push(z);
                                        D = P(D);
                                        w && f.push({ x: y, y: s, ctx: b, type: z.type, size: z.size, color: D, borderColor: D, borderThickness: z.borderThickness });
                                    }
                                    (m[u].indexLabel || k.indexLabel || m[u].indexLabelFormatter || k.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "line", dataPoint: m[u], dataSeries: k, point: { x: y, y: s }, direction: 0 > m[u].y === a.axisY.reversed ? 1 : -1, color: r });
                                }
                        c.stroke();
                        w && b.stroke();
                    }
                        ...
                        for (var C = !1, u = 0; u < m.length; u++)
                            if (((y = m[u].getTime ? m[u].x.getTime() : m[u].x), !(y < a.axisX.dataInfo.viewPortMin || (y > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !C)))))
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || C || n) && (c.stroke(), w && b.stroke()), (C = !0);
                                    ...
                                    this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: u, x1: y, y1: s };
                                    n || C
                                        ? (!n && k.connectNullData
                                              ? (c.setLineDash &&
                                                    (k.options.nullDataLineDashType || (p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType)) &&
                                              ...
                                              : (c.beginPath(), c.moveTo(y, s), w && (b.beginPath(), b.moveTo(y, s))),
                                          (C = n = !1))
                                        : (c.lineTo(y, D), w && b.lineTo(y, D), c.lineTo(y, s), w && b.lineTo(y, s), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(y, s), w && (b.stroke(), b.beginPath(), b.moveTo(y, s))));
                                    l = { x: y, y: s };
                                    u < m.length - 1 &&
                                        (h !== (m[u].lineColor || r) || p !== (m[u].lineDashType || k.lineDashType)) &&
                                        (c.stroke(),
                                        ...
                                        c.setLineDash && (m[u].lineDashType ? ((p = m[u].lineDashType), c.setLineDash(N(p, k.lineThickness))) : ((p = k.lineDashType), c.setLineDash(g))));
                                    if (0 < m[u].markerSize || 0 < k.markerSize)
                                        (D = k.getMarkerProperties(u, y, s, c)), f.push(D), (z = P(z)), w && f.push({ x: y, y: s, ctx: b, type: D.type, size: D.size, color: z, borderColor: z, borderThickness: D.borderThickness });
                                    (m[u].indexLabel || k.indexLabel || m[u].indexLabelFormatter || k.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stepLine", dataPoint: m[u], dataSeries: k, point: { x: y, y: s }, direction: 0 > m[u].y === a.axisY.reversed ? 1 : -1, color: r });
                                }
                        c.stroke();
                        w && b.stroke();
                    }
                            ...
                            if (((u = m[n].getTime ? m[n].x.getTime() : m[n].x), !(u < a.axisX.dataInfo.viewPortMin || (u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !y)))))
                                if ("number" !== typeof m[n].y)
                                    ...
                                    (m[n].indexLabel || k.indexLabel || m[n].indexLabelFormatter || k.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "spline", dataPoint: m[n], dataSeries: k, point: { x: u, y: y }, direction: 0 > m[n].y === a.axisY.reversed ? 1 : -1, color: r });
                                    y = !1;
                                }
                    d(s);
                }
                    ...
                    if (0 < r.length)
                        for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < r.length; f++)
                            if ((r[f].getTime ? (B = r[f].x.getTime()) : (B = r[f].x), !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y)) {
                                ...
                                ea(c, l, t, n, u, b, 0, null, h && 0 <= r[f].y, 0 > r[f].y && h, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                ...
                                var A = (m - (a.plotType.plotUnits.length * g) / 2 + a.index * g) << 0,
                                    C = (A + g) << 0,
                                    D;
                                ...
                                ea(c, A, p, C, D, b, 0, null, s && 0 <= u[k].y, 0 > u[k].y && s, !1, !1, n.fillOpacity);
                                b = n.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: A, y1: p, x2: C, y2: D };
                                b = P(b);
                                w && ea(this._eventManager.ghostCtx, A, p, C, D, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || n.indexLabel || u[k].indexLabelFormatter || n.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        bounds: { x1: A, y1: Math.min(p, D), x2: C, y2: Math.max(p, D) },
                                        color: b,
                                    });
                            }
                    }
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                ...
                                b = n.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: D, y1: A, x2: m, y2: C };
                                b = P(b);
                                w && ea(this._eventManager.ghostCtx, D, A, m, C, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || n.indexLabel || u[k].indexLabelFormatter || n.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1,
                                        bounds: { x1: Math.min(D, m), y1: A, x2: Math.max(D, m), y2: C },
                                        color: b,
                                    });
                            }
                    }
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                ...
                                b = P(b);
                                w && ea(this._eventManager.ghostCtx, A, C, m, D, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || n.indexLabel || u[k].indexLabelFormatter || n.indexLabelFormatter) &&
                                    this._indexLabels.push({
                            ...
                            if (((g = p[q].x.getTime ? p[q].x.getTime() : p[q].x), !(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r)))))
                                if ("number" !== typeof p[q].y)
                                    0 < q &&
                                        !r &&
                                        (m.connectNullData
                                            ? b.setLineDash && 0 < s.length && (m.options.nullDataLineDashType || !p[q - 1].lineDashType) && ((s[s.length - 1].newLineDashArray = x), (z = m.nullDataLineDashType))
                                            : (d(), (s = []))),
                                        (r = !0);
                                else {
                            ...
                            if (((s = r[h].x.getTime ? r[h].x.getTime() : r[h].x), !(s < a.axisX.dataInfo.viewPortMin || (s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))))) {
                                ...
                                "number" !== typeof r[h].y
                                    ...
                                    : ((n = a.axisX.convertValueToPixel(s)),
                                      ...
                                      (m = { x: n, y: u }),
                                      h < r.length - 1 &&
                                          (x !== (r[h].lineColor || v) || Q !== (r[h].lineDashType || g.lineDashType)) &&
                                          (b(),
                                          (x = r[h].lineColor || v),
                                          (f.strokeStyle = x),
                    ...
                    if (0 < m.length) {
                        ...
                        for (var Y = !0, q = 0; q < m.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y))))
                                if ("number" !== typeof fa.y) z.connectNullData || Y || y || d(), (Y = !0);
                                else {
                                    ...
                                    y || Y
                                        ? (!y && z.connectNullData
                                              ? (b.setLineDash &&
                                                    ...
                                                    ((y = k.pop()), (A = k[k.length - 1]), d(), b.moveTo(u.x, u.y), k.push(A), k.push(y), (A = z.nullDataLineDashType), b.setLineDash(aa)),
                                                b.lineTo(g, r),
                                                w && s.lineTo(g, r))
                                    ...
                                    u = { x: g, y: r };
                                    q < v.length - 1 &&
                                        (Q !== (v[q].lineColor || x) || A !== (v[q].lineDashType || z.lineDashType)) &&
                                        (d(),
                                        b.beginPath(),
                                        b.moveTo(g, r),
                                        k.push({ x: g, y: n - ma }),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
                    var v = a.dataSeriesIndexes[C],
                        ...
                        x = z.dataPoints;
                    z.dataPointIndexes = [];
                    for (q = 0; q < x.length; q++) (v = x[q].x.getTime ? x[q].x.getTime() : x[q].x), (z.dataPointIndexes[v] = q), e[v] || (m.push(v), (e[v] = !0));
                    m.sort(Qa);
                }
                for (C = 0; C < a.dataSeriesIndexes.length; C++) {
                                ...
                                if ("number" !== typeof fa.y) z.connectNullData || Y || s || d(), (Y = !0);
                                    ...
                                    s || Y
                                        ? (!s && z.connectNullData
                                          ...
                                          (Y = s = !1))
                                        : (b.lineTo(g, r), w && A.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), w && A.moveTo(g, r), k.push({ x: g, y: y - ba })));
                                    n = { x: g, y: r };
                                    q < x.length - 1 &&
                                        (Q !== (x[q].lineColor || E) || u !== (x[q].lineDashType || z.lineDashType)) &&
                                        (d(),
                                        b.beginPath(),
                                        b.moveTo(g, r),
                                        k.push({ x: g, y: y - ba }),
                                        (Q = x[q].lineColor || E),
                                        (b.strokeStyle = Q),
                                        b.setLineDash && (x[q].lineDashType ? ((u = x[q].lineDashType), b.setLineDash(N(u, z.lineThickness))) : ((u = z.lineDashType), b.setLineDash(F))));
                                    if (0 <= z.dataPointIndexes[f]) {
                                    ...
                                    (fa.indexLabel || z.indexLabel || fa.indexLabelFormatter || z.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stackedArea100", dataPoint: fa, dataSeries: z, point: { x: g, y: r }, direction: 0 > x[q].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        d();
                        b.moveTo(g, r);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var v = a.dataSeriesIndexes[n],
                        ...
                        y = u.dataPoints;
                    if (0 < y.length)
                        for (var A = 5 < r && u.bevelEnabled ? !0 : !1, t = 0; t < y.length; t++)
                            if (
                                ...
                                "candlestick" === u.type
                                    ? (c.moveTo(h - x, m),
                                      ...
                                      c.lineTo(h - x, p),
                                      c.stroke(),
                                      ea(c, C, Math.min(k, q), D, Math.max(k, q), y[t].y[0] <= y[t].y[3] ? u.risingColor : f, z, e, A, A, !1, !1, u.fillOpacity),
                                      w &&
                                          ((e = P(E)),
                                          (b.strokeStyle = e),
                                          b.moveTo(h - x, m),
                                    ...
                                    : "ohlc" === u.type &&
                                      ...
                                      w &&
                                          ...
                                          b.lineTo(D, q),
                                          b.stroke()));
                                (y[t].indexLabel || u.indexLabel || y[t].indexLabelFormatter || u.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: u.type,
                                        dataPoint: y[t],
                                        dataSeries: u,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = !1, n = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    var u = a.dataSeriesIndexes[v],
                        ...
                        A = y.dataPoints;
                    if (0 < A.length)
                        for (var C = 5 < r && y.bevelEnabled ? !0 : !1, l = 0; l < A.length; l++)
                            if (
                                ...
                                var D = (t - r / 2) << 0,
                                    ...
                                    E = 0 === x % 2 ? 0 : 0.5,
                                    Q = A[l].whiskerColor ? A[l].whiskerColor : A[l].color ? (y.whiskerColor ? y.whiskerColor : A[l].color) : y.whiskerColor ? y.whiskerColor : e,
                                    aa = "number" === typeof A[l].whiskerThickness ? A[l].whiskerThickness : "number" === typeof y.options.whiskerThickness ? y.whiskerThickness : x,
                                    F = A[l].whiskerDashType ? A[l].whiskerDashType : y.whiskerDashType,
                                    Y = s(A[l].whiskerLength) ? (s(y.options.whiskerLength) ? r : y.whiskerLength) : A[l].whiskerLength,
                                    Y = "number" === typeof Y ? (0 >= Y ? 0 : Y >= r ? r : Y) : "string" === typeof Y ? ((parseInt(Y) * r) / 100 > r ? r : (parseInt(Y) * r) / 100) : r,
                                    fa = 1 === Math.round(aa) % 2 ? 0.5 : 0,
                                    ma = A[l].stemColor ? A[l].stemColor : A[l].color ? (y.stemColor ? y.stemColor : A[l].color) : y.stemColor ? y.stemColor : e,
                                    ba = "number" === typeof A[l].stemThickness ? A[l].stemThickness : "number" === typeof y.options.stemThickness ? y.stemThickness : x,
                                    G = 1 === Math.round(ba) % 2 ? 0.5 : 0,
                                    J = A[l].stemDashType ? A[l].stemDashType : y.stemDashType,
                                    H = A[l].lineColor ? A[l].lineColor : A[l].color ? (y.lineColor ? y.lineColor : A[l].color) : y.lineColor ? y.lineColor : e,
                                    M = "number" === typeof A[l].lineThickness ? A[l].lineThickness : "number" === typeof y.options.lineThickness ? y.lineThickness : x,
                                ...
                                c.beginPath();
                                ea(c, D, Math.min(q, k), z, Math.max(k, q), xa, 0, e, n ? C : !1, n ? !1 : C, !1, !1, sa);
                                c.beginPath();
                                ea(c, D, Math.min(m, q), z, Math.max(q, m), R, 0, e, n ? !1 : C, n ? C : !1, !1, !1, sa);
                                c.beginPath();
                                c.lineWidth = x;
                                c.strokeStyle = e;
                                ...
                                w &&
                                    ...
                                    ea(b, D, Math.max(k, m), z, Math.min(k, m), e, 0, null, !1, !1, !1, !1),
                                ...
                                (A[l].indexLabel || y.indexLabel || A[l].indexLabelFormatter || y.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: y.type,
                                        dataPoint: A[l],
                                        dataSeries: y,
                        ...
                        for (var Q = !0; g < p.length; g++)
                            if (((u = p[g].x.getTime ? p[g].x.getTime() : p[g].x), !(u < a.axisX.dataInfo.viewPortMin || (u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !Q)))))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    q || Q
                                        ? (m.connectNullData && !q
                                              ? (b.setLineDash &&
                                                    ...
                                                    ((h[h.length - 1].newLineDashArray = E), (z = m.nullDataLineDashType), b.setLineDash(x)),
                                                b.lineTo(r, n),
                                                w && e.lineTo(r, n),
                                                h.push({ x: r, y1: n, y2: s }))
                                              : (b.beginPath(), b.moveTo(r, n), (y = { x: r, y: n }), (h = []), h.push({ x: r, y1: n, y2: s }), w && (e.beginPath(), e.moveTo(r, n))),
                                          (Q = q = !1))
                                    ...
                                    g < p.length - 1 &&
                                        (D !== (p[g].lineColor || v) || z !== (p[g].lineDashType || m.lineDashType)) &&
                                        (d(),
                                        (D = p[g].lineColor || v),
                                    ...
                                    if (p[g].indexLabel || m.indexLabel || p[g].indexLabelFormatter || m.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeArea", dataPoint: p[g], dataSeries: m, indexKeyword: 0, point: { x: r, y: n }, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? -1 : 1, color: A }),
                                            this._indexLabels.push({
                                                chartType: "rangeArea",
                                                dataPoint: p[g],
                                                dataSeries: m,
                        ...
                        for (g = !1; p < m.length; p++)
                            if (((q = m[p].x.getTime ? m[p].x.getTime() : m[p].x), !(q < a.axisX.dataInfo.viewPortMin || (q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))))
                                if (null !== m[p].y && m[p].y.length && "number" === typeof m[p].y[0] && "number" === typeof m[p].y[1]) {
                                    ...
                                    x[x.length] = { x: q, y: r };
                                    p < m.length - 1 &&
                                        (A !== (m[p].lineColor || y) || C !== (m[p].lineDashType || k.lineDashType)) &&
                                        ((A = m[p].lineColor || y),
                                        (s[s.length - 1].newStrokeStyle = A),
                                        b.setLineDash && (m[p].lineDashType ? ((C = m[p].lineDashType), (s[s.length - 1].newLineDashArray = N(C, k.lineThickness))) : ((C = k.lineDashType), (s[s.length - 1].newLineDashArray = D))));
                                    if (0 !== m[p].markerSize && (0 < m[p].markerSize || 0 < k.markerSize)) {
                                        ...
                                        f.push(F);
                                        Q = P(E);
                                        w && f.push({ x: q, y: r, ctx: e, type: F.type, size: F.size, color: Q, borderColor: Q, borderThickness: F.borderThickness });
                                    }
                                    ...
                                    0 < p &&
                                        !g &&
                                        (k.connectNullData
                                            ? b.setLineDash && 0 < s.length && (k.options.nullDataLineDashType || !m[p - 1].lineDashType) && ((s[s.length - 1].newLineDashArray = z), (C = k.nullDataLineDashType))
                                            : (d(D, y), (s = []), (x = []))),
                                        (g = !0);
                        d(D, y);
                        $.drawMarkers(f);
        ...
        n.prototype.renderWaterfall = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < v.length)
                        for (var A = 5 < q && s.bevelEnabled ? !0 : !1, C = !1, x = null, z = null, l = 0; l < v.length; l++)
                            if ((v[l].getTime ? (m = v[l].x.getTime()) : (m = v[l].x), "number" !== typeof v[l].y)) {
                                ...
                                0 < l &&
                                    ...
                                    c.lineTo(Q, aa - y),
                                    0 < u && c.stroke(),
                                    w && (b.beginPath(), b.moveTo(x, z - y), b.lineTo(Q, aa - y), 0 < u && b.stroke()));
                                C = !1;
                                x = F;
                                z = 0 < v[l].y ? n : k;
        ...
        n.prototype.renderPie = function (a) {
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < m.length) {
                    ...
                    k = 0;
                    k = "right" === p.hemisphere ? A.x + Math.sqrt(Math.pow(w, 2) - Math.pow(c - A.y, 2)) : A.x - Math.sqrt(Math.pow(w, 2) - Math.pow(c - A.y, 2));
                    ...
                    0 > c
                        ? ((h = "right" === p.hemisphere ? t : q),
                          ...
                          null !== h &&
                              ...
                              c - t < r && ((k = -t), (h = f(h, k, d + 1)), +h.toFixed(y) > +k.toFixed(y) && (l = c > r ? -(c - r) : -(t - (h - k))))))
                        : 0 < c &&
                          ...
                          null !== h &&
                              ...
                              c - t < r && ((k = t), (h = f(h, k, d + 1)), +h.toFixed(y) < +k.toFixed(y) && (l = c > r ? c - r : t - (k - h)))));
                    l &&
                            ...
                            if (null !== u) {
                                ...
                                if (0 > C) {
                                    ...
                                    var x = -1 * (C - s),
                                        J = (D = 0);
                                    "right" === h.hemisphere
                                        ? ((D = f(a, s)), (x = -1 * (C - D)), (J = f(u, x)), +J.toFixed(y) < +x.toFixed(y) && +D.toFixed(y) <= +s.toFixed(y) && f(a, -(x - J)))
                                        : ((D = f(u, s)), (x = -1 * (C - D)), (J = f(a, x)), +J.toFixed(y) < +x.toFixed(y) && +D.toFixed(y) <= +s.toFixed(y) && f(u, -(x - J)));
                                }
                            }
                        }
                    } else
                        for (a = 0; a < m.length; a++)
                            (h = g[a]), (w = "pie" === k.type ? 0.7 * z : 0.8 * z), (u = A.x + w * Math.cos(h.midAngle)), (s = A.y + w * Math.sin(h.midAngle)), (h.indexLabelTextBlock.x = u), (h.indexLabelTextBlock.y = s);
                    for (a = 0; a < m.length; a++)
                        if (((h = g[a]), (u = h.indexLabelTextBlock.measureText()), 0 !== u.height && 0 !== u.width))
                            (u = u = 0),
                                ...
                                0 < u &&
                                    (!l && h.indexLabelText && ((s = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1), 0 === f(a, u * s) && f(a, 2 * s)),
                                    Math.abs(h.indexLabelTextBlock.x - A.x) < z && ((u /= Math.abs(Math.sin(h.indexLabelAngle))), 9 < u && (u *= 0.3), u > d && (d = u)));
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var x = 0; x < m.length; x++)
                    (C += Math.abs(m[x].y)),
                        !a && "undefined" !== typeof m[x].indexLabel && null !== m[x].indexLabel && 0 < m[x].indexLabel.toString().length && (a = !0),
                        !a && "undefined" !== typeof m[x].label && null !== m[x].label && 0 < m[x].label.toString().length && (a = !0);
                if (0 !== C) {
        ...
        n.prototype.renderFunnel = function (a) {
            ...
            function b() {
                if (u && y) {
                    for (var a, b, c, d, e, f, k, l, h, m, p, q, t, n, r, B = [], v = [], A = { percent: null, total: null }, C = null, z = 0; z < y.length; z++)
                    ...
                    for (var z = 0, D = y.length - 1; z < y.length || 0 <= D; z++, D--) {
                        ...
                        t = u.dataPointIds[z];
                        x._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataPointIndex: z, dataSeriesIndex: 0, funnelSection: O[u.reversed ? y.length - 1 - z : z] };
                        ...
                        if (u.indexLabelFormatter || b.indexLabelFormatter) C = { chart: x.options, dataSeries: u, dataPoint: b, total: A.total, percent: A.percent };
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (
                    var u = this.data[a.dataSeriesIndexes[0]], y = u.dataPoints, A = this.plotArea, C = 0.025 * A.width, D = 0.01 * A.width, z = 0, E = A.height - 2 * C, F = Math.min(A.width - 2 * D, 2.8 * A.height), J = !1, H = 0;
                    H < y.length;
                    H++
                )
                    if (
                        (!J && "undefined" !== typeof y[H].indexLabel && null !== y[H].indexLabel && 0 < y[H].indexLabel.toString().length && (J = !0),
                        !J && "undefined" !== typeof y[H].label && null !== y[H].label && 0 < y[H].label.toString().length && (J = !0),
                        (!J && "function" === typeof u.indexLabelFormatter) || "function" === typeof y[H].indexLabelFormatter)
                    )
                        J = !0;
                ...
                if (0 != u.length && u.dataPoints && u.visible && 0 !== y.length) {
                    ...
                    if (-1 !== H) {
                        ...
                        if (u.reversed) for (G = 0; G < H.length; G++) F[G] < xa ? (a.push(L), D.push($), (ca = G)) : (a.push((F[G] - na + V * W) / V), D.push((F[G] - na + ea * T) / ea));
                        else for (G = 0; G < H.length; G++) F[G] < xa ? (a.push((F[G] - na + V * W) / V), D.push((F[G] - na + ea * T) / ea), (ca = G)) : (a.push(L), D.push($));
                        for (G = 0; G < H.length - 1; G++)
                            (Z = u.reversed ? (y[y.length - 1 - G].color ? y[y.length - 1 - G].color : u._colorSet[(y.length - 1 - G) % u._colorSet.length]) : y[G].color ? y[G].color : u._colorSet[G % u._colorSet.length]),
                                G === ca
                                    ? O.push({ x1: a[G], y1: F[G], x2: D[G], y2: F[G], x3: $, y3: xa, x4: D[G + 1], y4: F[G + 1], x5: a[G + 1], y5: F[G + 1], x6: L, y6: xa, id: G, height: F[G + 1] - F[G], color: Z })
                        ...
                        if (J && u.visible && (b(), f(), e(), "inside" !== u.indexLabelPlacement)) {
                            l();
                            for (G = 0; G < y.length; G++) I[G].isDirty || ((a = I[G].textBlock.x + I[G].width), (a = (M - a) / 2), 0 == G && (z = a), z > a && (z = a));
                            for (G = 0; G < O.length; G++) (O[G].x1 += z), (O[G].x2 += z), (O[G].x3 += z), (O[G].x4 += z), O[G].x5 && ((O[G].x5 += z), (O[G].x6 += z)), (I[G].textBlock.x += z);
                        }
                        for (G = 0; G < O.length; G++) (z = O[G]), pa(R, z, u.fillOpacity), ha.push(z.y1);
                        v(R);
                        J && u.visible && ("inside" === u.indexLabelPlacement || x.animationEnabled || m(R), x.animationEnabled || r());
                        if (!J)
                            for (G = 0; G < y.length; G++)
                                (z = u.dataPointIds[G]), (a = { id: z, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: O[u.reversed ? y.length - 1 - G : G] }), (x._eventManager.objectMap[z] = a);
                        ...
                        for (var y = 0; y < p.dataPoints.length; y++) {
                            var A = p.dataPoints[y],
                                ...
                                g = A.legendText
                                    ...
                                    ? A.name
                                    : "DataPoint: " + (y + 1),
                                r = A.legendMarkerColor ? A.legendMarkerColor : p.legendMarkerColor ? p.legendMarkerColor : A.color ? A.color : p.color ? p.color : p._colorSet[y % p._colorSet.length],
        ...
        E.setLayout = function (a, d, c, b, e, f) {
            ...
            for (var v = (w = 0), u = 0, y = 0, x = 0, C = 0, D = 0, z, E, F = (h = 0), H, J, K, r = (H = J = K = !1), g = 0; g < q.length; g++)
                q[g] &&
                    q[g].title &&
            ...
            if ("normal" === e) {
                for (var y = [], x = [], C = [], D = [], M = [], N = [], P = [], R = []; 4 > w; ) {
                    var G = 0,
                        ...
                        O = 0,
                        $ = 0;
                    if (c && 0 < c.length) for (C = [], g = O = 0; g < c.length; g++) C.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), (O += C[g]), (L += c[g] && !m.isNavigator ? c[g].margin : 0);
                            ...
                            a[g] &&
                                ...
                                !a[g] ||
                                    ...
                                    0 < a[g].labelAngle
                                        ...
                                        : 0 > a[g].labelAngle
                                        ? z - v < l && z - v < a[g].viewportMinimum && (F = l - (L + a[g].tickLength + C + z - v + a[g].labelFontSize / 2))
                                        : 0 === a[g].labelAngle && (E + u > n && (h = E + u / 2 - n - $), z - v < l && z - v < a[g].viewportMinimum && (F = l - L - a[g].tickLength - C - z + v / 2)),
                                ...
                                (a[g].bounds = { x1: l, y1: h, x2: n, y2: k - (T + e - y[g] - G), width: n - l, height: k - h })),
                                (G += y[g] + a[g].margin);
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            (d[g].lineCoordinates.x1 = Math.round(f.x1 + O + L)),
                                ...
                                (d[g].bounds = { x1: l, y1: h + (V + W - x[g] - S), x2: n, y2: k, width: n - l, height: k - h }),
                                (S += x[g] + d[g].margin);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            (L = m.isNavigator ? 0 : 10),
                                c[g] &&
                                    ...
                                    (c[g].bounds = { x1: l - (C[g] + U), y1: h, x2: n, y2: k, width: n - l, height: k - h }),
                ...
                for (N = []; 4 > w; ) {
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            (b[g].lineCoordinates = {}),
                                ...
                                b[g] && b[g].labelAutoFit && !s(C) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, C) : 0 === b[g].labelAngle ? Math.max(l, C / 2) : l), 0 < !d.length && (n -= D / 2)),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] &&
                                ...
                                (C = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle))),
                        ...
                        for (g = 0; g < a.length; g++) {
                            ...
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++)
                                    c[L] && c[L].labelAutoFit && ((n = 0 > c[L].labelAngle ? Math.max(n, y) : 0 === c[L].labelAngle ? Math.max(n, y / 2) : n), (l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - X : l));
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            ...
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++)
                                    c[L] && c[L].labelAutoFit && ((n = 0 > c[L].labelAngle ? Math.max(n, y) : 0 === c[L].labelAngle ? Math.max(n, y / 2) : n), (l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - T : l));
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    for (var x = 0; x < this.parent.dataSeries.length; x++)
                        (v = this.parent.dataSeries[x].getDataPointAtX(r, !0)) && 0 <= v.index && ((v.dataSeries = this.parent.dataSeries[x]), null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    v = null;
                    ...
                    if ("rangeBar" === m[0].dataSeries.type || "error" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[x].dataPoint.y[0])), u = 0, r = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length) for (var y = 0; y < m[r].dataPoint.y.length; y++) (u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y]))), u < v && ((v = u), (x = r));
                            else (u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y))), u < v && ((v = u), (x = r));
                    else if ("stackedBar" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), A = (u = 0), r = (x = 0); r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length) for (y = 0; y < m[r].dataPoint.y.length; y++) (u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y]))), u < v && ((v = u), (x = r));
                            else (A += m[r].dataPoint.y), (u = Math.abs(a - this.parent.convertValueToPixel(A))), u < v && ((v = u), (x = r));
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[x].type || "error" === this.parent.dataSeries[x].type) {
                            ...
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            A = u = 0;
                            for (r = x; 0 <= r; r--) (A += m[r].dataPoint.y), (u = Math.abs(a - this.parent.convertValueToPixel(A))), u < v && ((v = u), (b = r));
                        ...
                        if (C) {
                            if ("axisX" === this.parent.type)
                                for (r = this.parent.convertPixelToValue({ y: d }), v = null, x = 0; x < this.parent.dataSeries.length; x++)
                    ...
                    if (C) {
                        if ("axisX" === this.parent.type)
                            for (r = this.parent.convertPixelToValue({ x: a }), v = null, x = 0; x < this.parent.dataSeries.length; x++)
                                (v = this.parent.dataSeries[x].getDataPointAtX(r, !0)) &&
                                    0 <= v.index &&
                                    (k.text = this.labelFormatter
                                        ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x })
                    ...
                    if (
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y[0])), r = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length) for (y = 0; y < m[r].dataPoint.y.length; y++) (u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y]))), u < v && ((v = u), (x = r));
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = A = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length) for (y = 0; y < m[r].dataPoint.y.length; y++) (u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y]))), u < v && ((v = u), (x = r));
                            else (A += m[r].dataPoint.y), (u = Math.abs(d - this.parent.convertValueToPixel(A))), u < v && ((v = u), (x = r));
                    ...
                    if (
                        ...
                        A = u = 0;
                        for (r = x; 0 <= r; r--) (A += m[r].dataPoint.y), (u = Math.abs(d - this.parent.convertValueToPixel(A))), u < v && ((v = u), (b = r));
                        ...
                        "waterfall" === this.parent.dataSeries[x].type
                            ? ((w =
                              ...
                              (k.text = this.labelFormatter
                                  ...
                                  : s(this.options.label)
                                  ? da(c ? c : y.dataSeries.dataPointEOs[y.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo)
                                  : this.label),
                              (this.value = y.dataSeries.dataPointEOs[y.index].cumulativeSum))
                            : ((w = 1 === q.lineWidth % 2 ? (s(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0) + 0.5 : s(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0),
                              (k.text = this.labelFormatter
                                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : y.dataPoint.y })
                                  : s(this.options.label)
                                  ? da(c ? c : y.dataPoint.y, this.valueFormatString, this.chart._cultureInfo)
                                  : this.label),
                              (this.value = y.dataPoint.y));
                    ...
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        ...
                        if (C) {
                            ...
                            "dateTime" === this.parent.valueType
                                ? (k.text = this.labelFormatter
                                      ...
                                      : s(this.options.label)
                                      ? Ba(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo)
                                      : this.label)
                                : "number" === this.parent.valueType &&
                                  (k.text = this.labelFormatter
                                      ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(d) })
                                      : s(this.options.label)
                                      ? da(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo)
                                      : this.label);
                        ...
                        if ("bottom" === this.parent._position || "top" === this.parent._position)
                            (k.text = this.labelFormatter
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(a) })
                                : s(this.options.label)
                                ? da(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo)
                                : this.label),
                                (k.x = b - k.measureText().width / 2),
                                k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width),
                                k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1),
                    ...
                    if (C) {
                        ...
                        "dateTime" === this.parent.valueType
                            ? (k.text = this.labelFormatter
                                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(a) })
                                  : s(this.options.label)
                                  ? Ba(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo)
                                  : this.label)
                            : "number" === this.parent.valueType &&
                              (k.text = this.labelFormatter
            ...
            if (this.isToolTipDefinedInData && ((this.content && "function" === typeof this.content) || this.contentFormatter))
                            ...
                            "waterfall" === c.type
                                ...
                                ? (this.chart.axisX && 1 < this.chart.axisX.length && (f += n != c.axisXIndex ? (c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>") : ""),
                                  (f += b.toolTipContent
                                      ...
                                      : this.content && "function" !== typeof this.content
                                      ? this.content
                                      : "<span data-color='\"" + (this.options.fontColor ? "" : "'{color}'") + "\"'>{name}:</span><br/>Open:   {y[0]}<br/>High:    {y[1]}<br/>Low:   {y[2]}<br/>Close:   {y[3]}"))
                ...
                "waterfall" === c.type
                    ...
                    ? (f = b.toolTipContent
                          ...
                          : this.content && "function" !== typeof this.content
                          ? this.content
                          : "<span data-color='\"" + (this.options.fontColor ? "" : "'{color}'") + "\"'>" + (b.label ? "{label}" : "{x}") + "</span><br/>Open:   {y[0]}<br/>High:    {y[1]}<br/>Low:     {y[2]}<br/>Close:   {y[3]}")
                    : "boxAndWhisker" === c.type &&
                      (f = b.toolTipContent
                          ? b.toolTipContent
                          : c.toolTipContent
